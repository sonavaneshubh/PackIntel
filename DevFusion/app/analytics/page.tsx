...
export default function AnalyticsPage() {
  return (
    <AppShell pageTitle="Compliance Analytics">
      <div className="mb-6">
        <h2 className="text-display-lg-mobile md:text-display-lg font-display-lg text-on-surface mb-2">
          Compliance Analytics & Quality Trends
        </h2>
        <p className="text-body-base font-body-base text-on-surface-variant">
          Statistical breakdowns of label recognition accuracy, failure modes, and common discrepancies.
        </p>
      </div>
